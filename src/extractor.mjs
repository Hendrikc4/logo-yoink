...
import { rankCandidates, scoreCandidate, SOURCE_WEIGHT } from './rank.mjs';
...
export async function extractLogos(website, options = {}) {
  ...
  const unique = dedupeUrls(all)
    ...
    .slice(0, options.maxCandidates ?? MAX_CANDIDATES_TO_DOWNLOAD);
