...
if (!website || downloadIndex >= 0 && !downloadDirectory ||
  ...
  console.error('Usage: npm run cli -- <website> [--theme any|light|dark] [--background any|transparent|opaque] [--role icon|logo] [--download <directory>] [--deep-wide] [--spa-bundles] [--bimi]');
  process.exit(1);
}
