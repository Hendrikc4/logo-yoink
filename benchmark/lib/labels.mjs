...
export const CANDIDATE_SHEET_REVIEW_VERSION = 'visual-label-sheets-v3-candidate-only';
...
export function isCandidateSheetWorkflow(labelOrVersion) {
  const version = typeof labelOrVersion === 'string' ? labelOrVersion : labelOrVersion?.provenance?.prompt_version;
  return version === CANDIDATE_SHEET_REVIEW_VERSION;
}
