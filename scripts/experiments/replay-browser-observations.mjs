...
import { sanitizeCandidate, summarizeResults } from '../benchmark/benchmark.mjs';
...
async function main() {
  ...
  if (!runArg || !observationsArg || !outputArg) {
    throw new Error('Usage: node scripts/experiments/replay-browser-observations.mjs <static-run> <observations> <output-run>');
  }
