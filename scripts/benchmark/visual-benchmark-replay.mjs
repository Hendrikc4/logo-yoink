...
async function main() {
  ...
  if (options.help) {
    console.log('Usage: node scripts/benchmark/visual-benchmark-replay.mjs [--baseline-check] [--splits development,validation] [--profiles selection-v2,favicon-tiny-v1,icon-evidence-v1,wide-theme-v1,wide-header-recovery-v1] [--output FILE] [--selections-output FILE]');
    return;
  }
