...
if (!sourceProject || !originalSamplePath || !Number.isInteger(additionalCount) || additionalCount < 1) {
  console.error('Usage: node scripts/maintenance/export-company-fixture.mjs --source-project <path> --original-sample <json> [--output <json>] [--additional-count 400] [--seed <seed>]');
  process.exit(1);
}
