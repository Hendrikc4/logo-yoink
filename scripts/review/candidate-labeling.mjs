...
Prepare numbered contact sheets from an existing benchmark run:
  node scripts/review/candidate-labeling.mjs prepare --run runs/<id> [--output DIR] [--sheet-size 24]

Validate and merge AI responses:
  node scripts/review/candidate-labeling.mjs merge --packet DIR --input labels-01.jsonl [--input labels-02.jsonl] [--output FILE] [--allow-partial]
