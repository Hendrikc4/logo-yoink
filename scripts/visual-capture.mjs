...
import { captureShard } from '../src/visual-capture.mjs';

function usage() {
  return 'Usage: node scripts/visual-capture.mjs [--fixture path] [--output path] [--shard-index n] [--shard-count n] [--resume] [--timeout-ms n] [--max-instances n] [--max-crops n]';
}
