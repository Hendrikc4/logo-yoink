...
import { REVIEW_VERSION, validateCanonicalLabel, validateRankerSafeCandidateValues, isRankerSafeWorkflow } from './visual-benchmark-labels.mjs';
...
export function validateRecord(record, context = 'record') {
  ...
  if (type === 'label') validateCanonicalLabel(record, context);
