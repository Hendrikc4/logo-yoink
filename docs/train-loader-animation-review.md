...
- The completion state can freeze during the oversized invisible portion of the loop, leaving only the empty track above the result message even though the intended finished state includes the train.
