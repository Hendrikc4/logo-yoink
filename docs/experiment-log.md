...
| 2026-08-25 | [Embedded-logo description filter / Apple product-photo fix](embedded-logo-description-filter-2026-08-25.md) | BMW Spider-Man campaign image withheld; 1/1 changed selection was a reviewed false wide, with no correct regression | Validation withholds Apple's iPhone product photo; one-shot evaluation changes Lyft QR photo to a still-non-correct related asset; frozen-500 v6→v7 has 0 flips | Frozen replay 0 requests/bytes/AI calls; full-300 score unchanged at 66.19, strict selected precision 77.72%→78.14% | **Kept — product correctness; no synthesized or invented wide mark** |
| 2026-08-25 | [Major-brands-300 independent full review and ranking v6](major-brands-300-independent-review-and-ranking-v6-2026-08-25.md) | 2,732/2,732 candidates independently re-reviewed with exhaustive safety classes; narrow unlinked-DOM→declared-icon preference moves 158→162 correct selected slots and 63.70→64.51 | Validation 59→60 correct and 1→0 wrong-brand domains; one-shot evaluation 61→64 and 68.55→70.05; frozen-500 delta 5 gains/3 neutral/0 regressions | Frozen offline replay: 0 requests/bytes/API calls/$; 4,574 review judgments; broad rule rejected after Wendy/Nikon regressions | **Kept — benchmark semantics, strict review tooling, labels v4, and ranking v6** |
| 2026-08-25 | [Major-brands-300 broad declared-icon preference](major-brands-300-independent-review-and-ranking-v6-2026-08-25.md) | Recovered several correct icons, but blind pair review found a Wendy's regression and a blurrier Nikon replacement | Not promoted as a bundle | Zero-network replay; home-linked DOM marks were displaced | **Dropped — precision-limited** |
| 2026-08-25 | [Major-brands-300 semantic audit and selected-slot adjudication](major-brands-300-optimization-cycle-2026-08-25.md) | Reproduced 50.62 exactly; audited all 300 domains and all 127 reported-wrong slots: 84 same-brand false negatives, 29 non-logo, 11 related-brand, 2 unjudgeable, 1 true wrong-brand | Deterministic 180/60/60 split created before tuning; evaluation opened once after freeze; no-op retained bundle changed 0 slots | Selected-slot-only diagnostic becomes 72.27, but 2,605 other labels remain unaudited; production precision is only 325/368 = 88.32% | **Kept — benchmark semantics/provenance only; production STOP** |
| 2026-08-25 | [Major-brands-300 isolated ranking vetoes](major-brands-300-optimization-cycle-2026-08-25.md) | Four profiles tested independently; useful non-logo/foreign removals, but unlinked rule drops valid Heineken, foreign-name rule swaps Reclaim for Dropbox Sign, and combined profile inherits both defects | Unlinked and foreign-name rules changed 0 validation slots; descriptive/combined changed 2 and wrongly removed a valid Subway wordmark | Offline replay: +0 requests, bytes, or latency; no profile met validation gain plus zero-regression/98% precision gates | **Dropped — precision-limited and validation-zero-yield; no runtime change** |
| 2026-08-25 | [Major-brands-300 v3 capture and historical score](major-brands-300-stage-3-score-2026-08-24.md) | 227/300 captured; 2,732/2,732 candidates labeled; historical arithmetic 50.62/100 | Superseded by semantic audit above | Candidate omissions were conflated with wrong-brand; 103/227 is not an adjudicated wrong-brand count | **Superseded — artifact retained, quality claim withdrawn** |
| 2026-08-24 | Major-brands-300 preliminary candidate-only labeling pass | 226/300 captured and 2,731 tiles reviewed, but 1,932 were left ambiguous; 3,475 flat role rows could not support a complete selected-slot score | Superseded by the exhaustive v3 packet; not used for tuning or published quality claims | 114 sheets; incomplete-adjudication/label-policy limitation, not an extractor result | **Dropped — label-completeness-limited; raw run retained** |
| 2026-08-25 | [GPT-5.6 Luna identity-veto v2 context retest](luna-identity-verifier-context-retest-2026-08-25.md) | 38-case development: 9 accept, 22 reject, 7 ambiguous; zero wrong accepts; 100% accept precision; Willow→Because 1/1 and Digitoys 2/2 rejected; all Bhr wrong candidates withheld | Prepared/contextualized 120-case 60-wrong/60-correct fresh holdout, never reviewed; STOP | 58 domains/58 successes; 95 requests; 22,392,513 bytes; p50/p95 416/1,520 ms; 203.3 orchestration task-seconds; no product or benchmark change | **Dropped — recall/policy-limited under safety constraint** |
| 2026-08-25 | [GPT-5.6 Luna identity-veto v3 context retest](luna-identity-verifier-context-retest-2026-08-25.md) | 38-case development: 10 accept, 15 reject, 13 ambiguous; one Bhr→RealReports wrong accept; 9/10 = 90% accept precision; Digitoys 2/2 accepted; Willow rejected; STOP | Prepared/contextualized 120-case 60-wrong/60-correct fresh holdout, never reviewed | Same frozen context; 242.5 orchestration task-seconds; no product or benchmark change | **Dropped — precision-limited** |
| 2026-08-25 | [GPT-5.6 Luna identity-veto v4 context retest](luna-identity-verifier-context-retest-2026-08-25.md) | 38-case development: 3 accept, 22 reject, 13 ambiguous; zero wrong accepts; 100% accept precision; Because 1/1 and Digitoys 2/2 systematically rejected; FINAL STOP; no further tuning | Prepared/contextualized 120-case 60-wrong/60-correct fresh holdout, never reviewed; Workstream 2 forbidden | Same frozen context; 222.7 orchestration task-seconds; no product or benchmark change | **Dropped — recall/policy-limited under safety constraint** |
| 2026-08-25 | [GPT-5.6 Sol identity-veto v3 escalation](sol-identity-verifier-escalation-2026-08-25.md) | Same 38 fully contextualized development cases: 13 accept, 23 reject, 2 ambiguous; Userpilot and Genopets wrong accepts; 11/13 = 84.615% accept precision; Willow→Because and Digitoys handled acceptably; all Bhr wrong controls withheld | Prepared/contextualized 120-case fresh holdout untouched; FINAL STOP; no Workstream 2 | 844.3 orchestration task-seconds / 22.22 task-seconds per judgment; subscription tokens/dollars unavailable; no product or benchmark change | **Dropped — classification-precision-limited; worse observed task-time than Luna** |
| 2026-08-24 | [GPT-5.6 Luna identity-verifier feasibility gate](luna-identity-verifier-gate-2026-08-24.md) | 26-case harmful gate plus 12 hard-legitimate cases: exactly 1 genuine harmful accept (Userpilot), gate-only accept precision 1/2 = 50.0%, combined reviewed accept precision 6/7 = 85.714%; packet context lacked declared page identity and had 2 missing bytes/14 renderer exclusions | Not run; STOP/NO-GO and no Workstream 2 | 38 judgments; no external network; subscription tokens/dollars and actual marginal dollars unavailable; about 238.4 concurrent-task seconds in orchestration, not model latency | **Dropped — precision-limited under context limitation** |
| 2026-08-24 | [WS1 deferred AI identity verifier](identity-verifier-ws1-2026-08-24.md) | Module/CLI, versioned prompt, light/dark renderer, strict veto semantics, one-retry provider path, and zero-network byte-identical replay implemented; calibration not run | Not run; acceptance gate not reached | 0 live judgments/$0; API credential absent, 2/2,277 image bytes missing, packet page-identity fields absent, and challenge source run unavailable | **No-go — calibration-blocked and data-limited** |
...
The deferred missing-wide browser queue now clears both promotion gates when replayed after the full precision rerank. The implementation is deliberately off the foreground path: [`warm-browser-observations.mjs`](../scripts/experiments/warm-browser-observations.mjs) queues only successful, reachable records with no selected wide logo, caps shared-Chromium concurrency at two, and writes content-addressed observations. [`replay-browser-observations.mjs`](../scripts/experiments/replay-browser-observations.mjs) performs a zero-network merge, rejects duplicate bytes and URLs before ranking, and marks every browser addition wide-only so icon and favicon cannot move.
...
The small retained change is an explicit `max-age-ms` argument on [`warm-browser-observations.mjs`](../scripts/experiments/warm-browser-observations.mjs). Before expiry it preserves zero-network reuse; at or after expiry it atomically replaces the artifact through the existing full browser and candidate-validation path. `0` expresses always-refresh, while omitting the argument preserves the earlier infinite-reuse behavior for compatibility. No universal default TTL is claimed from an immediate-repeat experiment: deployments should select a finite maximum age from their freshness SLO, force refreshes for takedown/identity reports, and use full browser refresh on expiry. Conditional validation is not shipped because its apparent cost saving does not close the stale rendered-DOM safety gap.
...
- [Frozen 300 present-asset recovery](frozen-300-present-asset-recovery-2026-08-25.md)
