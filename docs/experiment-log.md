...
|---|---|---|---|---|---|
| 2026-08-25 | [Major-brands-300 v3 capture, exhaustive labels, and canonical score](major-brands-300-stage-3-score-2026-08-24.md) | 227/300 captured; 2,732/2,732 candidates reviewed; 368/368 selected icon/wide slots adjudicated; complete score 50.62/100 | Independent expansion cohort; no frozen-500 evaluation replay or tuning | 73 capture abstentions; icon 208/300 and wide 78/300 candidate-set coverage; 103/227 reachable domains had wrong-brand selected candidates | **Kept — benchmark/data/tooling only; production ranker unchanged** |
